...
const pieces = [
    ...
    new Piece("Battle of the Bulge", [INSTR, FILM], 1994, 30, { soundClick: "12343436" }, "Recorded to accompany an animated film of the same name produced at <A HREF=http://quickdrawanimation.ca/ target=_top>Quickdraw Animation Society</A>."),
    ...
    new Piece("Bouncing Belly Button", [INSTR, FILM], 1994, 0, {}, "Recorded to accompany an animated film of the same name, produced at <A HREF=http://quickdrawanimation.ca/ target=_top>Quickdraw Animation Society</A>."),
    ...
    new Piece("Champagne", [INSTR, FILM], 1994, 0, {}, "Recorded to accompany an animated film of the same name, produced at <A HREF=http://quickdrawanimation.ca/ target=_top>Quickdraw Animation Society</A>."),
    ...
    new Piece("Evolution of the Long-Tailed Bird", [INSTR, FILM], 1994, 0, {}, "Recorded to accompany an animated film of the same name, produced at <A HREF=http://quickdrawanimation.ca/ target=_top>Quickdraw Animation Society</A>."),
    ...
    new Piece("Four-track improvisation in 11/8", [INSTR], 1984, 178, {}, "I dragged my new DX7 into the electronic music lab at the University of Calgary and spent the holidays playing around. (I had no multitracking capability at home.)"),
    new Piece("Four-track improvisation in 15/8", [INSTR], 1984, 286, {}, "I dragged my new DX7 into the electronic music lab at the University of Calgary and spent the holidays playing around. (I had no multitracking capability at home.)."),
    new Piece("Four-track improvisation in 4/4", [INSTR], 1984, 233, {}, "I dragged my new DX7 into the electronic music lab at the University of Calgary and spent the holidays playing around. (I had no multitracking capability at home.)."),
    new Piece("The Front Door", [PIANO], 1990, 213, {}, "Slow, melancholy. Part of an impromptu suite of pieces, preceded by <em>The Kitchen Stirs At Dawn</em> and followed by <em>Glow in the Rear View Mirror</em>."),
    ...
    new Piece("Les Pingoins explorent/The Exploring Penguins I", [FILM], 1990, 61, { soundClick: "12343441" }, "Music and sounds for the first of two versions of the animated film of the same name."),
    new Piece("Les Pingoins Explorent/The Exploring Penguins II", [FILM], 1991, 121, { soundClick: "12348568" }, "Music and sounds for the second of two versions of the animated film of the same name."),
    ...
    new Piece("Meedra Ma", [FILM], 1994, 38, { soundClick: "12348570" }, "Scored for piano and bass; composed to accompany an animated film of the same name, produced at <A HREF=http://quickdrawanimation.ca/ target=_top>Quickdraw Animation Society</A>."),
    ...
    new Piece("Quality Time", [FILM], 1994, 0, { soundClick: "12343452" }, "Recorded to accompany an animated film of the same name, produced at <A HREF=http://quickdrawanimation.ca/ target=_top>Quickdraw Animation Society</A>."),
    ...
    new Piece("Scuba Siv", [FILM], 1994, 0, {}, "Two versions of this music were composed for two versions of Don Filipchuk's animated film of the same name, produced at <A HREF=http://quickdrawanimation.ca/ target=_top>Quickdraw Animation Society</A>."),
    ...
    new Piece("Siv Polka", [FILM], 1998, 49, { youtube: "eeJwf6THfnI" }, "Scored for solo accordion. Composed and recorded for Don Filipchuk's animated film, <B>Vacuum Siv</B>, produced at <A HREF=http://quickdrawanimation.ca/ target=_top>Quickdraw Animation Society</A."),
    new Piece("Siv Tango", [FILM], 1998, 71, { youtube: "uA4JxAdt3XM" }, "Scored for accordion, bass, and shaker. Composed and recorded for Don Filipchuk's animated film, <B>Vacuum Siv</B>, produced at <A HREF=http://quickdrawanimation.ca/ target=_top>Quickdraw Animation Society</A."),
    ...
    new Piece("Unstoppable", [PIANO], 1998, 103, { pdf: "Unstoppable.pdf" }, "Scored for piano, intermediate difficulty, phrygian mode. Also scored as a string quartet. I also stole thematic material for the soundtrack to an animated film, <B>Type A</B>, by Ray Smith, produced at <A HREF=http://quickdrawanimation.ca/ target=_top>Quickdraw Animation Society</A>."),
